...
- Bump `org.mockito:mockito-junit-jupiter` from 5.6.0 to 5.10.0 ([#87](https://github.com/SAIC-iSmart-API/saic-java-client/pull/87), [#100](https://github.com/SAIC-iSmart-API/saic-java-client/pull/100), [#113](https://github.com/SAIC-iSmart-API/saic-java-client/pull/113))
