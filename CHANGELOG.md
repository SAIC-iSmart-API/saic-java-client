...
- Bump `com.diffplug.spotless:spotless-maven-plugin` from 2.38.0 to 2.42.0 ([#83](https://github.com/SAIC-iSmart-API/saic-java-client/pull/83), [#103](https://github.com/SAIC-iSmart-API/saic-java-client/pull/103), [#111](https://github.com/SAIC-iSmart-API/saic-java-client/pull/111))
