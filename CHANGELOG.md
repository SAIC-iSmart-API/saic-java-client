...
- Bump `org.apache.maven.plugins:maven-failsafe-plugin` from 3.1.2 to 3.2.3 ([#84](https://github.com/SAIC-iSmart-API/saic-java-client/pull/84), [#90](https://github.com/SAIC-iSmart-API/saic-java-client/pull/90), [#105](https://github.com/SAIC-iSmart-API/saic-java-client/pull/105))
