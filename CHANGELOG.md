...
- Bump `org.codehaus.mojo:exec-maven-plugin` from 3.1.0 to 3.4.1 ([#93](https://github.com/SAIC-iSmart-API/saic-java-client/pull/93), [#139](https://github.com/SAIC-iSmart-API/saic-java-client/pull/139))
