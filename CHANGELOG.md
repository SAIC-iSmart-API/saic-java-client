...
- Bump `com.diffplug.spotless:spotless-maven-plugin` from 2.38.0 to 2.41.0 ([#83](https://github.com/SAIC-iSmart-API/saic-java-client/pull/83), [#99](https://github.com/SAIC-iSmart-API/saic-java-client/pull/99))
